...
dag = DAG(
    ...
    end_date=dt.datetime(year=2019, month=1, day=3),
    tags=["user_events"]
)
...
fetch_events = BashOperator(
    ...
    bash_command="""
    curl -o /home/ubuntu/Downloads/data/events_noformat.json -L 'http://127.0.0.1:5000/events?start_date={{ds}}&end_date={{next_ds}}';
